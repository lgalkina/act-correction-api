...
// Source: github.com/lgalkina/act-correction-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/lgalkina/act-correction-api/internal/model"
)
...
func (m *MockEventRepo) Add(arg0 []model.CorrectionEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.CorrectionEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.CorrectionEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
